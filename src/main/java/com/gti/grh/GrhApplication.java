...
public class GrhApplication {
    ...
    public CommandLineRunner loadData(ContratTypeRepository contratTypeRepository, AvantageSalaireRepository avantageSalaireRepository, DepartementRepository departementRepository, NiveauEtudeRepository niveauEtudeRepository, PosteRepository posteRepository, ResponsableRepository responsableRepository, CollaborateurRepository collaborateurRepository) {
        return args -> {
            ...
            AvantageSalaire avantage1 = new AvantageSalaire(null, "ticket resto");
            AvantageSalaire avantage2 = new AvantageSalaire(null, "prime");     
            ...
            Collaborateur collaborateur1 = new Collaborateur(null,77777,"khouloud",4587541,256985,20145623,"2010-01-22","khuloud@gmail.com","sfax","informatique","angular",1,1,10,11,15,6,4, contrat1, niveau3, poste1, responsable1, departement1, avantage2);
            Collaborateur collaborateur2 = new Collaborateur(null,12546,"Hazar",2563154,11111,53621500,"2008-12-03","hazar@gmail.com","nabeul","buisness","angular",3,2,9,12,16,7,5, contrat2, niveau2, poste2, responsable2, departement2, avantage1);
            Collaborateur collaborateur3 = new Collaborateur(null,444521,"khalil",1258745,2222,22120451,"2005-06-10","khalil@gmail.com","sousse","test et qualité","springboot",5,3,8,13,15,7,5, contrat3, niveau1, poste3, responsable1, departement2, avantage1);
            Collaborateur collaborateur4 = new Collaborateur(null,332015,"maissa",2140006,78542,99856321,"2000-10-10","maissa@gmail.com","bizerte","developpement","springboot",4,1,8,11,16,7,5, contrat1, niveau1, poste1, responsable2, departement2, avantage1);
            Collaborateur collaborateur5 = new Collaborateur(null,562000,"omar",22500365,555231,44512,"2015-11-05","omar@gmail.com","ben arous","test et qualité","selenium",2,2,9,12,15,7,5, contrat2, niveau2, poste2, responsable1, departement2, avantage1);
            Collaborateur collaborateur6 = new Collaborateur(null,452361,"Amal",23001500,775210,12003,"2012-10-01","amal@gmail.com","mahdia","informatique","angular",6,3,10,11,15,6,4, contrat3, niveau3, poste1, responsable1, departement1, avantage2);
            Collaborateur collaborateur7 = new Collaborateur(null,523642,"Rahma",58562312,5699857,36550,"2014-09-01","rahma@gmail.com","beja","ressource humaine","jira",2,3,10,14,15,6,4, contrat3, niveau3, poste4, responsable1, departement1, avantage2);
